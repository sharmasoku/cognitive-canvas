    ...
    <section className="relative overflow-hidden py-20 lg:py-28 bg-[#fdfdfb]">
      ...
      <div className="section-container relative z-10">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-[24px] border border-white/10 bg-gradient-to-r from-[#4ade80] via-[#22c55e] to-[#22c55e] p-6 sm:p-8 shadow-[0_15px_35px_-15px_rgba(34,197,94,0.3)] max-w-4xl mx-auto mt-12"
        >
          ...
          <div className="relative flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4 text-center sm:text-left flex-col sm:flex-row">
              <div className="grid h-12 w-12 place-items-center rounded-full bg-white text-[#22c55e] shadow-[0_0_15px_rgba(255,255,255,0.2)]">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#25d366] px-5 py-2.5 text-xs font-semibold text-black shadow-[0_4px_15px_rgba(0,0,0,0.08)] transition hover:scale-105 hover:bg-[#20ba59] active:scale-95"
            >
